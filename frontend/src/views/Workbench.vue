  ...
  <section class="welcome-panel">
    <div class="welcome-copy">
      <div class="section-kicker">
        <span class="tiny-line"></span>让训练与保障业务协同运行
      </div>
      <h2>从一项任务，<br />到一次完整的保障闭环。</h2>
      <p>
        贯通操作训练、维修培训与保障筹划演练，<br
          class="desktop-only"
        />让每个方案可验证，每次改进有依据。
      </p>
      <div class="button-row">
        <button class="btn dark" @click="go('S301')">
          <Icon name="Plus" :size="16" />创建保障任务</button
        ><button class="text-btn" @click="store.guide = true">
          查看演示流程<Icon name="ArrowRight" :size="16" />
        </button>
      </div>
